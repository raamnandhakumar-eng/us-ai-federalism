...
**Search date:** August 25, 2026  
**Status:** living review; update before circulating the paper
...
3. transparent federal-ceiling, carve-out, and federal-floor counterfactuals; and
4. quotation-backed model assistance followed by human legal verification.

The defensible novelty statement is:

> To our knowledge as of August 25, 2026, this is the first statute-level empirical study to
> estimate how alternative federal AI preemption rules would change population-weighted coverage
...
| IAPP and NCSL trackers | Current bill discovery and descriptive classifications | Track measures but do not define this paper's enforceable-obligation estimands |
| Kalmenovitz et al. (2025), *Journal of Finance* | Evidence on firm effects of fragmentation across federal regulators | Establishes the importance of fragmentation but studies a different institutional setting and outcome |
| Migineishvili et al. (2026), *Regulating AI: Where U.S. State Policy and HCI (Mis)align* | Analysis of state AI committees and reports against HCI concerns | Studies policy recommendations rather than enacted obligations and federal preemption scenarios |
...
- Dawson, G. S., Desouza, K. C., Denford, J. S., and Picavet, M. E. B. (2026). “Analyzing the
  Passage of State-Level AI Bills.” Brookings Institution.
  https://www.brookings.edu/articles/analyzing-the-passage-of-state-level-ai-bills/
- Fu, Y., and Phillips-Robins, A. (2025). “When Should Congress Preempt State AI Law? The Lessons
  of Past Technologies.” Carnegie Endowment for International Peace.
  https://carnegieendowment.org/research/2025/09/congress-preempt-state-ai-law-the-lessons-of-past-technologies
- Kalmenovitz, J., Lowry, M., and Volkova, E. (2025). “Regulatory Fragmentation.” *Journal of
  Finance*. https://doi.org/10.1111/jofi.13423
...
- International Association of Privacy Professionals. “U.S. State AI Governance Legislation
  Tracker.” https://iapp.org/resources/article/us-state-ai-governance-legislation-tracker
- Migineishvili, N., Gao, A., Adjagbodjou, A., Thakur, D., Just, R., and Reinecke, K. (2026).
  “Regulating AI: Where U.S. State Policy and HCI (Mis)align.” arXiv.
  https://arxiv.org/abs/2607.03292
